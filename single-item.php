...
$query = "SELECT * FROM `tblpromopro` pr , `tblproduct` p , `tblcategory` c
            WHERE pr.`PROID`=p.`PROID` AND  p.`CATEGID` = c.`CATEGID`  AND p.`PROID`=" . $PROID . " and p.PROSTATS='Available'";
$mydb->setQuery($query);
...
?>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <ul>
                    ...
                    <li>Type - <p style=" white-space: pre;"><?php echo    $result->PRODESC; ?></p></li>
                    <li>Price - &#8369 <?php echo $result->PRODISPRICE; ?></li>
    ...
    <?php
    $query = "SELECT * FROM `tblpromopro` pr , `tblproduct` p , `tblcategory` c
            WHERE pr.`PROID`=p.`PROID` AND  p.`CATEGID` = c.`CATEGID` and p.PROSTATS='Available'  AND `CATEGORIES`='" . $result->CATEGORIES . "' limit 4";
    $mydb->setQuery($query);
    $cur = $mydb->loadResultList();
    ?>
