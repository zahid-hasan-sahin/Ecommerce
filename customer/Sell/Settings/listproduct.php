		...
		<table id="dash-table" class="table table-striped table-bordered table-hover " style="font-size:12px" cellspacing="0">
			...
			<tbody>
				...
				foreach ($cur as $result) {
					...
					echo '<td>  <p style=" white-space: pre;">' . $result->PRODESC . '</p> </td>';
					...
					echo
					'<td align="left">
							<a href="' . web_root . 'customer/sell/settings/controller.php?action=editStatus&id=' . $result->PROID . '&stats=' . $stats . '" class="btn btn-primary btn-xs">' . $stats . '</a>
